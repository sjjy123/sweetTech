...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: '40%', top: 40, left: 0, $opacity: 0.6 ,$currentclass:'prev2',$currenttext:'hidden'},
            { '&zIndex': 2, width: '45%', top: 20, left: '10%', $opacity: 0.7 ,$currentclass:'prev1',$currenttext:'hidden' },
            { '&zIndex': 3, width: '50%', top: 0, left: '25%', $opacity: 1 ,$currentclass:'current',$currenttext:'' },
            { '&zIndex': 2, width: '45%', top: 20, left: '45%', $opacity: 0.7 ,$currentclass:'next1',$currenttext:'hidden' },
            { '&zIndex': 1, width: '40%', top: 40, left: '60%', $opacity: 0.6 ,$currentclass:'next2',$currenttext:'hidden' }
        ]
        ...
        move: function () {
            ...
            this.lis.each(function (i, el) {
                $(el)
                    ...
                    .removeAttr("class")
                    .addClass(this.states[i].$currentclass)
                ...
                $(el).closest("#Slide1").siblings("h5[data-index="+index+"]").removeAttr("class").addClass(this.states[i].$currenttext);
            }.bind(this))
        },
        // 让轮播图切换到下一张
        next: function () {
