...
class clsUpload{
	var $saveName;// 保存名
	var $savePath;// 保存路径
	var $fileFormat = array('gif','GIF','jpg','JPG','doc','DOC','application/octet-stream');// 文件格式&MIME限定
		...
		if(isset($_FILES[$fileInput])){
			...
			}else
			{
				...
				if($this->copyfile($fileArr)){
					//$this->returnArray[] =  $this->returninfo;
					global $fieldname;
					echo "<script>parent.document.getElementById(\"$fieldname\").value=\"".$this->saveName."\"</script>";
