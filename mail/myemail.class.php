...
//发送邮件的类
    ...
    var $sock;
    /* Constractor */
    function myemail($relay_host = "", $smtp_port = 25,$auth = false,$user,$pass){
        $this->debug = FALSE;
...
//$smtp = new myemail($smtpserver,$smtpserverport,true,$smtpuser,$smtppass);		//这里面的一个true是表示使用身份验证,否则不使用身份验证.
